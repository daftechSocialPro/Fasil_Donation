...
function AddDesignId({ setIsLodding,template }) {
  ...
  const photoInputHandler = (e) => {
    ...
    fileReader.onload = () => {
      ...
      background.style? background.style.backgroundImage = `url(${fileReader.result})`:""
    }
    ...
    try {
      await axios
        ...
        .then((res) => {
          ...
          setAddressAm('')
window.location.reload()
          customToast('DeSign ID Template Successfully updated', 0)
