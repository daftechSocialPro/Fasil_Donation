...
import { assetUrl, urlNextMatch } from '../../../endpoints'


function NextMatchEdit({ user ,setIsLodding}) {
  ...
  const [SeasonName, setSeasonName] = useState(NextMatch.seasonName)
  const [MatchName, setMatchName] = useState(NextMatch.matchName)
  const [MatchDateTime, setMatchDateTime] = useState(NextMatch.matchDateTime)
                ...
                <MDBCol lg="4">
                  <MDBCard className="mb-4">
                    <MDBCardBody className="text-center">
                      <MDBCardImage
                        src={img ? URL.createObjectURL(img) : getImage(NextMatch.awayLogo)}
                        alt="avatar"
